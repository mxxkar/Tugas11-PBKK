function onFormSubmit(event) {
    ...
    var form = FormApp.openById('1KqR5r6VSK9Zu0E86Lu3P4NRnPBLqIywLiHjtLlE664c'); // Form ID
  ...
  function AddRecord(nama, jenis_kelamin, tanggal_lahir, alamat) {
    var url = 'https://docs.google.com/spreadsheets/d/1cm-SFi4D7wNhtYxqNnZe5atiQ5dHzX9DSnvCsgEevfM/edit#gid=0';
